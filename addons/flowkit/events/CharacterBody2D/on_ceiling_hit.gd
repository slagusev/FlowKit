extends FKEvent
func get_description() -> String: return "Fires when CharacterBody2D hits ceiling (edge)."
func get_id() -> String: return "on_ceiling_hit"
func get_name() -> String: return "On Ceiling Hit"
...
func poll(node: Node, inputs: Dictionary = {}, block_id: String = "") -> bool:
	...
	var key := "fk_was_ceil_" + block_id
	var was: bool = bool(node.get_meta(key, false))
	var now: bool = body.is_on_ceiling()
