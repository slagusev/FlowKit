extends FKEvent
func get_description() -> String: return "Fires when BaseButton emits button_down (drag/hold start helper)."
func get_id() -> String: return "on_ui_drag_started"
func get_name() -> String: return "On Press Started"
