extends FKEvent
func get_description() -> String: return "Fires when another Area3D enters. Stored as system.last_area."
func get_id() -> String: return "on_area_entered_3d"
func get_name() -> String: return "On Area Entered (3D)"
...
func teardown(node: Node, block_id: String = "") -> void:
	if is_instance_valid(node) and node is Area3D and _callback.is_valid() and node.area_entered.is_connected(_callback):
