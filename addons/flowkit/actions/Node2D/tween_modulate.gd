extends FKAction
func get_description() -> String: return "Tweens CanvasItem modulate color."
func get_id() -> String: return "node2d_tween_modulate"
func get_name() -> String: return "Tween Modulate"
