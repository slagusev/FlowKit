...
func get_description() -> String:
	return "Compares a Call Subsheet parameter (p_name) with a value."

func get_id() -> String:
	return "compare_subsheet_param"

func get_name() -> String:
	return "Compare Subsheet Param"

func get_inputs() -> Array[Dictionary]:
	return [
		{"name": "Name", "type": "String", "description": "Subsheet parameter name (no p_ prefix)."},
...
func check(node: Node, inputs: Dictionary, block_id: String = "") -> bool:
	...
	if system == null or not ("subsheet_params" in system):
		return false
	var var_value: Variant = system.subsheet_params.get(vname, null)
	match op:
